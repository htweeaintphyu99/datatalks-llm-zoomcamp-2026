...
Answer: **AI Copilot has access to current Kestra plugin documentation** so it performs better in generating Kestra flows.
...
- 200-400 tokens
- 500+ tokens  
Answer: 59 tokens which is approximately **60-100 tokens**
...
- 10-20x more
- 50x more  
Answer: Output token count for `multilingual_agent` with `summary_length=long`is 169 which is 2.8x more. So approximate answer is **2-5x more**.
...
- 5-10x more
- 10x+ more  
3-sentence ~ 109 output tokens  
1-sentence ~ 39 output tokens  
Answer: **2-4x more**
...
### [When to Use What](https://github.com/DataTalksClub/llm-zoomcamp/blob/main/03-orchestration/lessons/08-best-practices.md)
